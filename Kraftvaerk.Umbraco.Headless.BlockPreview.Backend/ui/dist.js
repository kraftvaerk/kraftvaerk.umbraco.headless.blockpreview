...
var h = (s, e, t) => (Ne(s, e, "read from private field"), t ? t.call(s) : e.get(s)), k = (s, e, t) => e.has(s) ? Be("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(s) : e.set(s, t), $ = (s, e, t, i) => (Ne(s, e, "write to private field"), i ? i.call(s, t) : e.set(s, t), t);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pt, defineProperty: ft, getOwnPropertyDescriptor: mt, getOwnPropertyNames: bt, getOwnPropertySymbols: _t, getPrototypeOf: yt } = Object, B = globalThis, De = B.trustedTypes, $t = De ? De.emptyScript : "", $e = B.reactiveElementPolyfillSupport, G = (s, e) => s, fe = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? $t : null;
      break;
...
j.elementStyles = [], j.shadowRootOptions = { mode: "open" }, j[G("elementProperties")] = /* @__PURE__ */ new Map(), j[G("finalized")] = /* @__PURE__ */ new Map(), $e == null || $e({ ReactiveElement: j }), (B.reactiveElementVersions ?? (B.reactiveElementVersions = [])).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, me = J.trustedTypes, xe = me ? me.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Xe = "$lit$", R = `lit$${Math.random().toFixed(9).slice(2)}$`, Ze = "?" + R, gt = `<${Ze}>`, x = document, Y = () => x.createComment(""), X = (s) => s === null || typeof s != "object" && typeof s != "function", Oe = Array.isArray, vt = (s) => Oe(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", ge = `[ 	
\f\r]`, F = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, qe = /-->/g, je = />/g, N = RegExp(`>|${ge}(?:([^\\s"'>=/]+)(${ge}*=${ge}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ve = /'/g, We = /"/g, Qe = /^(?:script|style|textarea|title)$/i, Et = (s) => (e, ...t) => ({ _$litType$: s, strings: e, values: t }), re = Et(1), q = Symbol.for("lit-noChange"), m = Symbol.for("lit-nothing"), Ke = /* @__PURE__ */ new WeakMap(), I = x.createTreeWalker(x, 129);
function et(s, e) {
...
const At = (s, e) => {
  ...
  for (let a = 0; a < t; a++) {
    const l = s[a];
    let c, b, u = -1, y = 0;
    for (; y < l.length && (o.lastIndex = y, b = o.exec(l), b !== null); ) y = o.lastIndex, o === F ? b[1] === "!--" ? o = qe : b[1] !== void 0 ? o = je : b[2] !== void 0 ? (Qe.test(b[2]) && (r = RegExp("</" + b[2], "g")), o = N) : b[3] !== void 0 && (o = N) : o === N ? b[0] === ">" ? (o = r ?? F, u = -1) : b[1] === void 0 ? u = -2 : (u = o.lastIndex - b[2].length, c = b[1], o = b[3] === void 0 ? N : b[3] === '"' ? We : Ve) : o === We || o === Ve ? o = N : o === qe || o === je ? o = F : (o = N, r = void 0);
    const T = o === N && s[a + 1].startsWith("/>") ? " " : "";
    n += o === F ? l + gt : u >= 0 ? (i.push(c), l.slice(0, u) + Xe + l.slice(u) + R + T) : l + R + (u === -2 ? a : T);
  }
    ...
    for (; (r = I.nextNode()) !== null && l.length < a; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const u of r.getAttributeNames()) if (u.endsWith(Xe)) {
          const y = b[o++], T = r.getAttribute(u).split(R), te = /([.?@])?(.*)/.exec(y);
          l.push({ type: 1, index: n, name: te[2], strings: T, ctor: te[1] === "." ? St : te[1] === "?" ? Tt : te[1] === "@" ? kt : ye }), r.removeAttribute(u);
...
class Q {
  ...
  _$AI(e, t = this) {
    e = K(this, e, t), X(e) ? e === m || e == null || e === "" ? (this._$AH !== m && this._$AR(), this._$AH = m) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : vt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== m && X(this._$AH) ? this._$AA.nextSibling.data = e : this.T(x.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
...
class ye {
  ...
  _$AI(e, t = this, i, r) {
    ...
    let o = !1;
    if (n === void 0) e = K(this, e, t, 0), o = !X(e) || e !== this._$AH && e !== q, o && (this._$AH = e);
    else {
      const a = e;
      let l, c;
      for (e = n[0], l = 0; l < n.length - 1; l++) c = K(this, a[i + l], t, l), c === q && (c = this._$AH[l]), o || (o = !X(c) || c !== this._$AH[l]), c === m ? e = m : e !== m && (e += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    o && !r && this.j(e);
  }
  j(e) {
...
class Mt {
  constructor(e) {
    ...
    k(this, W);
    k(this, H);
    $(this, A, !1), $(this, w, !1), $(this, g, !1), $(this, U, []), $(this, D, new Promise((t, i) => {
      $(this, W, t), $(this, H, i);
      const r = (a) => {
        h(this, A) || h(this, w) || h(this, g) || ($(this, A, !0), h(this, W) && h(this, W).call(this, a));
      }, n = (a) => {
        h(this, A) || h(this, w) || h(this, g) || ($(this, w, !0), h(this, H) && h(this, H).call(this, a));
      }, o = (a) => {
        h(this, A) || h(this, w) || h(this, g) || h(this, U).push(a);
      };
  ...
  cancel() {
    if (!(h(this, A) || h(this, w) || h(this, g))) {
      if ($(this, g, !0), h(this, U).length)
        try {
...
A = new WeakMap(), w = new WeakMap(), g = new WeakMap(), U = new WeakMap(), D = new WeakMap(), W = new WeakMap(), H = new WeakMap();
const Re = (s) => s != null, ee = (s) => typeof s == "string", Ae = (s) => ee(s) && s !== "", Ue = (s) => typeof s == "object" && typeof s.type == "string" && typeof s.stream == "function" && typeof s.arrayBuffer == "function" && typeof s.constructor == "function" && typeof s.constructor.name == "string" && /^(Blob|File)$/.test(s.constructor.name) && /^(Blob|File)$/.test(s[Symbol.toStringTag]), st = (s) => s instanceof FormData, xt = (s) => {
  try {
    return btoa(s);
  } catch {
  ...
  try {
    ...
    if (!r.isCancelled) {
      const c = await zt(s, e, n, a, o, l, r), b = await Gt(c), u = Ft(c, e.responseHeader), y = {
        url: n,
        ok: c.ok,
        status: c.status,
...
let p = class extends Ge {
  ...
  render() {
    ...
    })), d(this, O) || f(this, O, this.content), d(this, L) || f(this, L, this.settings), d(this, le).forEach((o) => {
      this.manageButtons(o);
    }), p.useBeamFallback || d(this, S) === "blockbeam" || d(this, ce) && !((s = d(this, P)) != null && s.enabledNested) || !((e = d(this, P)) != null && e.enabledGrid) && d(this, he) || !((t = d(this, P)) != null && t.enabledList) && d(this, de) || !((i = d(this, P)) != null && i.enabledRTE) && d(this, ue) || d(this, V) ? this.blockBeam(d(this, V)) : re`<div class="__headless-preview"><a href=${((r = this.config) != null && r.showContentEdit ? (n = this.config) == null ? void 0 : n.editContentPath : void 0) ?? ""}>${Lt(d(this, S))}</a></div>`;
  }
  async init() {
    f(this, S, p.loadingBarHtml), this.consumeContext(ot, (s) => {
      var t;
      f(this, oe, (t = s == null ? void 0 : s.getVariantId()) == null ? void 0 : t.culture), console.log(s == null ? void 0 : s.getHostElement().tagName), f(this, he, (s == null ? void 0 : s.getHostElement().tagName) === "UMB-PROPERTY-EDITOR-UI-BLOCK-GRID"), f(this, de, (s == null ? void 0 : s.getHostElement().tagName) === "UMB-PROPERTY-EDITOR-UI-BLOCK-LIST"), f(this, ue, (s == null ? void 0 : s.getHostElement().tagName) === "UMB-PROPERTY-EDITOR-UI-TIPTAP");
      const e = s == null ? void 0 : s.getHostElement();
      e != null && f(this, le, this.findAllInShadowRoots("uui-action-bar", e));
  ...
  checkReadiness() {
    setTimeout(() => {
      d(this, S) === p.loadingBarHtml ? ((d(this, C) === null || d(this, C) === void 0) && f(this, ce, !0), this.getHtmlString()) : this.checkReadiness();
    }, 500);
  }
  uiLoop() {
    setTimeout(() => {
      d(this, ae) !== p.useBeamFallback && (f(this, ae, p.useBeamFallback), this.requestUpdate()), this.uiLoop();
    }, 100);
  }
  async getHtmlString() {
    var e, t;
