...
export default function publish() {
    ...
    const solutionPath = join(rootDir, 'Kraftvaerk.Umbraco.Headless.BlockPreview.sln');
    const projectPath = join(rootDir, 'Kraftvaerk.Umbraco.Headless.BlockPreview.Backend');
    const csprojectPath = join(projectPath, 'Kraftvaerk.Umbraco.Headless.BlockPreview.Backend.csproj');
