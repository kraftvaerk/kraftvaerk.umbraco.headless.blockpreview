 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: pt, defineProperty: mt, getOwnPropertyDescriptor: ft, getOwnPropertyNames: bt, getOwnPropertySymbols: _t, getPrototypeOf: $t } = Object, B = globalThis, De = B.trustedTypes, yt = De ? De.emptyScript : "", ye = B.reactiveElementPolyfillSupport, G = (s, e) => s, me = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? yt : null;
      break;
  ...
  return t;
} }, Pe = (s, e) => !pt(s, e), Me = { attribute: !0, type: String, converter: me, reflect: !1, useDefault: !1, hasChanged: Pe };
...
let j = class extends HTMLElement {
  ...
  _$ET(e, t) {
    ...
    if (r !== void 0 && i.reflect === !0) {
      const o = (((n = i.converter) == null ? void 0 : n.toAttribute) !== void 0 ? i.converter : me).toAttribute(t, i.type);
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const a = i.getPropertyOptions(r), l = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((n = a.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? a.converter : me;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, fe = J.trustedTypes, xe = fe ? fe.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Xe = "$lit$", R = `lit$${Math.random().toFixed(9).slice(2)}$`, Ze = "?" + R, gt = `<${Ze}>`, x = document, Y = () => x.createComment(""), X = (s) => s === null || typeof s != "object" && typeof s != "function", Oe = Array.isArray, vt = (s) => Oe(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", ge = `[ 	
\f\r]`, F = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, qe = /-->/g, je = />/g, N = RegExp(`>|${ge}(?:([^\\s"'>=/]+)(${ge}*=${ge}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ve = /'/g, We = /"/g, Qe = /^(?:script|style|textarea|title)$/i, Et = (s) => (e, ...t) => ({ _$litType$: s, strings: e, values: t }), re = Et(1), q = Symbol.for("lit-noChange"), f = Symbol.for("lit-nothing"), Ke = /* @__PURE__ */ new WeakMap(), I = x.createTreeWalker(x, 129);
function et(s, e) {
...
const At = (s, e) => {
  ...
  for (let a = 0; a < t; a++) {
    const l = s[a];
    let c, b, u = -1, $ = 0;
    for (; $ < l.length && (o.lastIndex = $, b = o.exec(l), b !== null); ) $ = o.lastIndex, o === F ? b[1] === "!--" ? o = qe : b[1] !== void 0 ? o = je : b[2] !== void 0 ? (Qe.test(b[2]) && (r = RegExp("</" + b[2], "g")), o = N) : b[3] !== void 0 && (o = N) : o === N ? b[0] === ">" ? (o = r ?? F, u = -1) : b[1] === void 0 ? u = -2 : (u = o.lastIndex - b[2].length, c = b[1], o = b[3] === void 0 ? N : b[3] === '"' ? We : Ve) : o === We || o === Ve ? o = N : o === qe || o === je ? o = F : (o = N, r = void 0);
    ...
    for (; (r = I.nextNode()) !== null && l.length < a; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const u of r.getAttributeNames()) if (u.endsWith(Xe)) {
          const $ = b[o++], T = r.getAttribute(u).split(R), te = /([.?@])?(.*)/.exec($);
        ...
        if (Qe.test(r.tagName)) {
          ...
          if ($ > 0) {
            ...
            for (let T = 0; T < $; T++) r.append(u[T], Y()), I.nextNode(), l.push({ type: 2, index: ++n });
            r.append(u[$], Y());
          }
        }
...
class Q {
  ...
  _$AI(e, t = this) {
    e = K(this, e, t), X(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== q && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : vt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== f && X(this._$AH) ? this._$AA.nextSibling.data = e : this.T(x.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
...
class $e {
  ...
  _$AI(e, t = this, i, r) {
    ...
    if (n === void 0) e = K(this, e, t, 0), o = !X(e) || e !== this._$AH && e !== q, o && (this._$AH = e);
      ...
      const a = e;
      let l, c;
      for (e = n[0], l = 0; l < n.length - 1; l++) c = K(this, a[i + l], t, l), c === q && (c = this._$AH[l]), o || (o = !X(c) || c !== this._$AH[l]), c === f ? e = f : e !== f && (e += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    o && !r && this.j(e);
  }
  j(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Rt = { attribute: !0, type: String, converter: me, reflect: !1, hasChanged: Pe }, Ut = (s = Rt, e, t) => {
...
class Mt {
  constructor(e) {
    ...
    k(this, W);
    k(this, H);
    y(this, A, !1), y(this, w, !1), y(this, g, !1), y(this, U, []), y(this, D, new Promise((t, i) => {
      y(this, W, t), y(this, H, i);
      const r = (a) => {
        h(this, A) || h(this, w) || h(this, g) || (y(this, A, !0), h(this, W) && h(this, W).call(this, a));
      }, n = (a) => {
        h(this, A) || h(this, w) || h(this, g) || (y(this, w, !0), h(this, H) && h(this, H).call(this, a));
      }, o = (a) => {
...
let p = class extends Ge {
  ...
  async init() {
    m(this, S, p.loadingBarHtml), this.consumeContext(ot, (s) => {
      var t;
  ...
  checkReadiness() {
    setTimeout(() => {
      d(this, S) === p.loadingBarHtml ? ((d(this, C) === null || d(this, C) === void 0) && m(this, ce, !0), this.getHtmlString()) : this.checkReadiness();
    }, 500);
  }
  uiLoop() {
    setTimeout(() => {
      ...
      this.consumeContext(pe, async (i) => {
        ...
        if (r) {
          ...
          try {
            ...
            m(this, S, o.html ?? "blockbeam");
          } catch (o) {
            m(this, S, "blockbeam"), m(this, V, o instanceof Error ? o.message : "Unknown error");
          }
          this.requestUpdate();
        }
      });
    } catch (i) {
      m(this, S, "blockbeam"), m(this, V, i instanceof Error ? i.message : "Unknown error");
    }
  }
  blockBeam(s) {
    var t, i;
