 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, fe = J.trustedTypes, qe = fe ? fe.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Xe = "$lit$", R = `lit$${Math.random().toFixed(9).slice(2)}$`, Ze = "?" + R, vt = `<${Ze}>`, q = document, Y = () => q.createComment(""), X = (s) => s === null || typeof s != "object" && typeof s != "function", Oe = Array.isArray, Et = (s) => Oe(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", be = `[ 	
    ...
    for (; (r = I.nextNode()) !== null && l.length < a; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const u of r.getAttributeNames()) if (u.endsWith(Xe)) {
          const y = _[o++], T = r.getAttribute(u).split(R), te = /([.?@])?(.*)/.exec(y);
        ...
        if (Qe.test(r.tagName)) {
          const u = r.textContent.split(R), y = u.length - 1;
          if (y > 0) {
...
class Mt {
  constructor(e) {
    ...
    k(this, W);
    k(this, H);
    b(this, A, !1), b(this, w, !1), b(this, v, !1), b(this, U, []), b(this, D, new Promise((t, i) => {
...
let p = class extends Ge {
  ...
  blockBeam(s) {
    return this.label + (s ? `- Rendering-error:  ${s}` : ""), Ae`
